...
INSERT INTO "new_Invoice" ("clientAccount", "clientAddress", "clientBank", "clientBankCode", "clientEmail", "clientId", "clientName", "clientPhone", "clientRegNr", "createdAt", "date", "id", "number", "supplierId", "total", "updatedAt") SELECT "clientAccount", "clientAddress", "clientBank", "clientBankCode", "clientEmail", "clientId", "clientName", "clientPhone", "clientRegNr", "createdAt", "date", "id", "number", "supplierId", "total", "updatedAt" FROM "Invoice";
DROP TABLE "Invoice";
